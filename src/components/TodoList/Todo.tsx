...
export const Todo:React.FC<TodoProps> = ({item, id, complete, completed})=> {
    ...
    return (
        <li  key={`${item}+${id}`}>
            <div className='checkbox'>
                <input onChange={(e:ChangeEvent<HTMLInputElement>)=>completeHandler(e)} type="checkbox" id={`${id}`} checked={completed}/>
                <label htmlFor={`${id}`}>
